...
import { BiChevronDown,BiMenu,BiChevronRight , BiSearch } from "react-icons/bi";
const NavSm= () =>{
    return(
        <>
...
const NavMd= () =>{
    return(
        <div className="w-full flex items-center bg-white gap-3 px-3 py-3 rounded-sm">
            <BiSearch/>
...
const Navbar = () => {
    return(
        ...
        <nav className="bg-navCol-800 px-4 py-2">
            ...
            <div className = "md:hidden lg:hidden md:flex">{
                //Tablet Screen
                <NavMd/>
